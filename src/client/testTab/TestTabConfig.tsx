...
/**
 * Implementation of test configuration page
 */
export const TestTabConfig = () => {
    ...
    const onSaveHandler = (saveEvent: pages.config.SaveEvent) => {
        ...
        pages.config.setConfig({
            contentUrl: host + "/testTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            websiteUrl: host + "/testTab/?name={loginHint}&tenant={tid}&group={groupId}&theme={theme}",
            suggestedDisplayName: "test",
            removeUrl: host + "/testTab/remove.html?theme={theme}",
